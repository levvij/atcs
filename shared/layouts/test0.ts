...
test0.segments = [
	new Block("a.a", 60.2 * 0.87, { 
		max: 30,
		optimal: 20
	}, [], undefined, "a.m"),

	new Block("a.m", 71.3 * 0.87, { 
		max: 50,
		optimal: 40
	}, [], "a.a", "t1"),
	
	new Turnout("t1", 43.3 / 2 * 0.87, {
		max: 80,
		optimal: 60
	}, 20, 3, false, {
		middle: "m.sw",
	...
	new Block("m.se", 103.1 * 0.87, { 
		max: 80,
		optimal: 60
	}, [], "t1", "m.ne"),

	new Block("m.ne", 82.5 * 0.87, { 
		max: 80,
		optimal: 60
	}, [], "m.se", "m.n"),

	new Block("m.n", 47.8 * 0.87, { 
		max: 80,
		optimal: 60
	}, [], "m.ne", "m.nw"),

	new Block("m.nw", 79.2 * 0.87, {
		max: 80,
		optimal: 60
	}, [], "m.n", "m.sw"),

	new Block("m.sw", 82.5 * 0.87, {
		max: 80,
		optimal: 60
	}, [], "m.nw", "t1")
];
